...
namespace TrafficSimulation
{
    ...
    public class IntersectionEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUI.BeginDisabledGroup(intersection.intersectionType != IntersectionType.AMBULANCE_STOP);

            EditorGUILayout.LabelField("Ambulance", EditorStyles.boldLabel);
            SerializedProperty ambPrioritySegment = serializedObject.FindProperty("ambpriority");
            EditorGUILayout.PropertyField(ambPrioritySegment, new GUIContent("Priority Segment"), true);
            serializedObject.ApplyModifiedProperties();
